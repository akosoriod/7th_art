...
var Entity = function (params) {
    ...
    function attachEvents() {
        ...
        self.div.dblclick(function () {
            ...
            if (editor.mode !== "solution" 
                    && (self.type !== "check" && self.type !== "answers" 
                    && self.type !== "record" && self.type !== "list" 
                    && self.type !== "wall")) {
...
//                    self.entities[j].updatePositionByDiff(diffLeft,diffTop);
    ...
    function getHtml() {
        ...
        var editing = "";
        if (editor.mode === "edition") {
            if (self.type === "check" || self.type === "answers" 
                    || self.type === "record" || self.type === "wall") {
