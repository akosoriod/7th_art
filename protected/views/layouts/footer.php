<footer>
    <div class="row">
        ...
        <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12 logos">
            <a href="http://www.orgulloun.unal.edu.co">
                <?php 
                    echo CHtml::image(Yii::app()->request->baseUrl."/images/unal/log_orgullo.png","Orgullo UN",array(
                        'width'=>78,
                        'height'=>21,
                        'title'=>'Orgullo UN'
                    )); 
            ...
            <a href="http://www.agenciadenoticias.unal.edu.co/inicio.html" class="imgAgencia">
                <?php 
                    echo CHtml::image(Yii::app()->request->baseUrl."/images/unal/log_agenc.png","Agencia de Noticias",array(
                        'width'=>78,
                        'height'=>21,
            ...
            <a href="http://www.gobiernoenlinea.gov.co/web/guest">
                <?php 
                    echo CHtml::image(Yii::app()->request->baseUrl."/images/unal/log_gobiern.png","Programa gobierno en línea",array(
                        'width'=>67,
                        'height'=>51,
                        'title'=>'Programa gobierno en línea'
                    )); 
                ?>
            </a>
            <a href="http://www.contaduria.gov.co/">
                <?php 
                    echo CHtml::image(Yii::app()->request->baseUrl."/images/unal/log_contra.png","Contaduría general de la republica",array(
                        'width'=>67,
                        'height'=>51,
                        'title'=>'Contaduría general de la republica'
                    )); 
                ?>
            </a>
        </div>
