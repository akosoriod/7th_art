        <main class="detalle">
            <div class="row row1">
                <div id="divAboutUsEng" class="col-xs-12 col-sm-12 col-md-7">
                    ...
                    <p>
                    <div id="div_img_process_eng" class="col-xs-12 col-sm-12 col-md-5">
                        <img id="img_process_eng" src="<?php echo Yii::app()->request->baseUrl; ?>/images/test/7thart_process.png" height="402" width="659" alt="process"/>
                    </div>
                    </p>
                    <p><div>&nbsp;</div></p>
                    <p><div>&nbsp;</div></p>
                    ...
                    <li>
                    lts adaptation process to HTML5 is being done through interdisciplinary work that involves the participation of graduates and under and postgraduate students of seven Academic Units -four faculties- with the support afstalï teachers, as shown in the chart below.
                    </li>
                    <li>
